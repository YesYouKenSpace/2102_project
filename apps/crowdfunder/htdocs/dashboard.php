		...
		<section class="content">
			...
			<div class="col-lg-3">
				<div class="small-box bg-blue">
					...
					<a href="admin/users.php" class="small-box-footer">View Details <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
			<div class="col-lg-3">
			...
			<div class="col-lg-3">
				<div class="small-box bg-yellow">
					...
					<a href="admin/projects.php" class="small-box-footer">View Details <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
			<div class="col-lg-3">
